/**
 * SVG Path unary tokens
 *
 * @typedef {Object} ScannerPathToken
 * @prop {String} type - The type of token,
 *   it can be any of: `command`, `comma_wsp`, `number`, `unknown`, `wsp`
...
class PathScanner {
   ...
   *
   * The SVG path syntax can be summarized into 5 unary {@link ScannerPathToken} types.
