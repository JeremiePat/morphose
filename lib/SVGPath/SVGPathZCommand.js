...
class SVGPathZCommand extends SVGPathCommand {
   ...
   *
   * **IMPORTANT:** _Due to their nature, all END commands will respond with a
   * `0,0` end point's coordinate tuple (the actual ending point of the command
   * is the one of the closest previous MOVE command) and they are always
   * considered being relative._
   */
  constructor () {
    super(0, 0, true)
  }
