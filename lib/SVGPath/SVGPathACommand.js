 ...
 */
const a = (rx, ry, angle, large, clockwise, x, y) => new SVGPathACommand(rx, ry, angle, large, clockwise, x, y, true)
 ...
 */
const A = (rx, ry, angle, large, clockwise, x, y) => new SVGPathACommand(rx, ry, angle, large, clockwise, x, y)
